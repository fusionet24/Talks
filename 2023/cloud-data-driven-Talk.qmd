...
::: footer
Learn more: [DailyDatabricks Site](https://dailydatabricks.tips/tips/Notebook/context.html)
:::
...
Get current cell executing code
...
## Configiruation Objects (A little context)

Spark configurations for parameters, customisation, optimization etc 

They can be set at a Cluster Level or at session Level.
...
``` {.sql code-line-numbers="0|1|3|5" code-overflow="wrap"}
CREATE TABLE MY_EXAMPLE_TABLE (id INT,country STRING DEFAULT 'UNKNOWN') USING CSV

INSERT INTO my_example_table VALUES (1, DEFAULT)

INSERT INTO my_example_table VALUES (1)
...
## 7. Turn Delta tables to Append only{auto-animate="true"}
::: {.callout-tip title="Intermediate TIP" appearance="simple"}
...
## 11. (Bonus) New(ish) Databricks Notebook Kernel
::: {.callout-tip}
### Intermediate TIP
:::
- Ipython based! 
...
![](images/datetime.png){width="1000"}
...
- Find out about DailyDatabricks @dailydatabricks
